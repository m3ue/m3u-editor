<div>
    ...
    @else
        ...
        @php
            $discoverSections = [
                ['id' => 'trending', 'label' => __('Trending This Week'), 'icon' => 'heroicon-o-fire', 'iconColor' => 'warning', 'items' => $trendingItems],
                ['id' => 'popular-movies', 'label' => __('Popular Movies'), 'icon' => 'heroicon-o-film', 'iconColor' => 'info', 'items' => $popularMovies],
                ['id' => 'popular-tv', 'label' => __('Popular TV'), 'icon' => 'heroicon-o-tv', 'iconColor' => 'primary', 'items' => $popularTv],
                ['id' => 'upcoming-movies', 'label' => __('Upcoming Movies'), 'icon' => 'heroicon-o-calendar-days', 'iconColor' => 'success', 'items' => $upcomingMovies],
            ];
        @endphp
