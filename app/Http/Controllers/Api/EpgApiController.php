        ...
        try {
            ...
            foreach ($playlistChannels as $channel) {
                ...
                $playlistChannelData[$channelKey] = [
                    ...
                    'tvg_id' => $tvgId,
                    'display_name' => $channel->title_custom ?? $channel->title,
                    'display_title' => $playerAttributes['display_title'] ?? $channel->title_custom ?? $channel->title ?? $channel->name_custom ?? $channel->name,
                    'title' => $playerAttributes['title'] ?? $channel->name_custom ?? $channel->name,
                    'channel_number' => $channelNo,
                    'group' => $channel->group ?? $channel->group_internal,
                    'icon' => $icon,
                    'has_epg' => $epgId !== null,
