...
class TmdbService
{
     ...
     * Discover movies with optional filters.
     *
     * @param  array<string, mixed>  $params  TMDB /discover/movie query params (include 'page' for pagination)
     ...
     *
     * @param  array<string, mixed>  $params  TMDB /discover/tv query params (include 'page' for pagination)
     * @return array{results: array<int, array<string, mixed>>, total_pages: int}
     */
